<?php /* Smarty version 2.6.14, created on 2010-12-06 15:04:23
         compiled from theme_header.tpl */ ?>
<style>
...
#dingHeader_s1 .dingNavL_s1 { float: left; width: 245px;}
#dingHeader_s1 .dingNavL_s1 li { float: left; height: 29px; line-height: 29px; text-align: center; background: url(<?php echo @STATIC_URL; ?>
images/header/ding_top_s1.gif) no-repeat left -81px;}
...
';
	...
	$(function () {
		...
		var msgCount = $("#onloadMsg").text();
		if (msgCount == 0) {
			$("#onloadMsg").closest("a").addClass('color666').text('系统消息');
		}	
	});
	...
	{
		clearTimeout(headerPlaygameTimeout);
		if(headerPlaygame[headerPlaygameIndex] != "") $(".fadeInPlaygame").html(headerPlaygame[headerPlaygameIndex]);
		$(".fadeInPlaygame").fadeIn('slow');
		if (headerPlaygameIndex == 49) headerPlaygameIndex = 0;
		else headerPlaygameIndex++;
		headerPlaygameTimeout = setTimeout('$(".fadeInPlaygame").fadeOut(1000);', 5000);
	}
</script>
...
">·超级富豪</a>
			...
			<ul class="dingNavL_s1">
				<li id="fadeInPlaygame" class="fadeInPlaygame" style="display:none; text-align:center; background:none; width: 280px; overflow:hidden;"></li>
			</ul>
...
paysearch/index" title="充值查询">充值查询</a>
		...
		<li class="dingTopSysmsg_s1">
			<a href="<?php echo @SITE_URL; ?>
msg/">系统消息(<span id="onloadMsg"><?php echo $this->_tpl_vars['msgCount']; ?>
</span>)</a>
		</li>
...
help/common/" target="_blank">帮助</a></li>
		<li class="dingTopQuit_s1"><a target="_self" href="javascript:location.href='<?php echo @PASSPORT_URL; ?>
member/logout/?referer='+location.href;">退出</a></li>
	</ul>
<?php else: ?>
...
help/common/" target="_blank">帮助</a></li>
		<li class="dingTopLogin_s1">
			<p>
				<a target="_self" href="javascript:location.href='<?php echo @PASSPORT_URL; ?>
member/login/?referer='+location.href;">登陆</a><a target="_self" href="javascript:location.href='<?php echo @PASSPORT_URL; ?>
member/register/?referer='+location.href;">注册</a></p>
		</li>
	</ul>
<?php endif; ?>
		<div class="clear">
