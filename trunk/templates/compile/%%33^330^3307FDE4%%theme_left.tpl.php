...
<!--                     <td width="65"><img src="<?php echo $this->_tpl_vars['STATIC_URL']; ?>
images/yzm.jpg" width="55" height="24" /></td>-->
...
<?php else: ?>
	  <div class="gy_dl1">
          <div class="gy_dl_later">
               <div class="new_dl">
                    <div class="yh_name">
                          <div class="yg_name_tp"><img src="<?php echo @STATIC_URL; ?>
images/touxiang.jpg" width="95" height="91" /></div>
...
<?php endif; ?> 
          ...
          <div class="gy_game">
               <div class="gy_game_z"><img src="<?php echo $this->_tpl_vars['STATIC_URL']; ?>
images/hot.jpg" width="110" height="140" /></div>
               <div class="gy_game_y">
                    <p class="hot1">本周人气游戏</p>
                    <p class="name">独孤九剑</p>
                    <p class="pingce">玩家评测 <span class="jibie"></span></p>
                    <p class="pc_nr">斯顿飞神雕客服哈斯顿飞神雕客服哈斯顿宋德福和未成年人家</p>
                    <p><a href="#" target="_blank"><img src="<?php echo $this->_tpl_vars['STATIC_URL']; ?>
images/star.jpg" width="68" height="23" /></a></p>
               </div>
       </div>
