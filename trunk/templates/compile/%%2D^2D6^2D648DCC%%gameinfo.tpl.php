<?php /* Smarty version 2.6.14, created on 2011-11-24 09:37:59
         compiled from gameinfo.tpl */ ?>
...
var playgame = {
	check: function(){
		...
		$.ajax({
			async: false,
			type: "GET",
			url: "http://yy.51yx.com/member/ajaxLogin/?do_md5=1&jsoncallback=?",
	...
	create: function(){
		...
		$.ajax({
			async: false,
			type: "GET",
			url: "http://yy.51yx.com/gameinfo/createJS/?jsoncallback=?",
