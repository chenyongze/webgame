	...
	<div id="reg_wrap">
    	<div id="reg_inner">
            ...
            <div class="reg_bd">
				...
				<p style="text-indent:67px;"><{$smarty.const.VALID_NUMBER}><a class="change" style="color:#a20d05;" href="javascript:void(0)" onclick="document.getElementById('valid_src').src='<{$smarty.const.SITE_URL}>member/validn/?f='+Math.random()" >看不清？换一个</a></p>
