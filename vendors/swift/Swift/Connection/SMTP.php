...
class Swift_Connection_SMTP extends Swift_ConnectionBase
{
  ...
  public function start()
  {
    ...
    {
      $error_msg = "The SMTP connection failed to start [" . $server . ":" . $this->port . "]: fsockopen returned Error Number " . $errno . " and Error String '" . mb_convert_encoding($errstr,'UTF-8','GBK') . "'";
	  //echo iconv('GBK','UTF-8',$errstr);exit;
      if ($log->isEnabled())
      {
